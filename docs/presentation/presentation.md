...
footer: "Cloud Infra Project - 2026-04-07"
style: |
  section.lead h1 {
    text-align: center;
    color: #00d4ff;
...
<!--
[발표자 스크립트]
결론입니다. 이번 프로젝트를 통해 우리는 엔터프라이즈 환경에서 요구되는 보안과 가용성을 코드 기반으로 실현했습니다. 
수동 운영의 리스크를 줄이고, 확장 가능한 인프라 표준을 정립한 것이 가장 큰 성과입니다. 
향후에는 퍼블릭 클라우드 연동을 통해 더 유연한 하이브리드 환경으로 발전시켜 나갈 계획입니다. 경청해 주셔서 감사합니다.
-->
