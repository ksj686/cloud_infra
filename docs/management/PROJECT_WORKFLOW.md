...
| 날짜       | 결정 사항                      | 배경 및 근거                                                                                                                                                                                                                    | 반영 위치                                                                                                                                                                                    |
| :--------- | :----------------------------- | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2026-05-02 | `project_compare.md` 선별 반영 | 대화 내용은 AWS ECS 중심 2주 배포 프로젝트에 최적화되어 있어 현재 온프레미스 Phase 1-7 구조와 일부 충돌함. 프로젝트 방향을 유지하면서 LB 선택 기준, Ceph 용도, 직접 운영 DB 대안, 하이브리드 K8s 확장 모델만 반영               | `docs/management/PROJECT_COMPARE_REVIEW.md`, `docs/architecture/project_outline.md`, `docs/architecture/build-up/06_scalability/README.md`, `docs/architecture/build-up/07_hybrid/README.md` |
| 2026-05-01 | commit/push 검사 단계 분리     | SCA 도구(`pnpm audit`, `pip-audit`)는 실행 시간이 길고 로컬 환경 의존성이 있어 매 커밋 실행 시 개발 흐름을 지연시킴. 커밋 단계는 빠른 품질/시크릿 검사로 유지하고, 푸시 단계에서 전체 파일 기준 보안/SCA 검사를 수행하도록 분리 | `.pre-commit-config.yaml`, `.husky/pre-commit`, `.husky/pre-push`, `docs/management/ENVIRONMENT_SETUP.md`, `ADR-005`                                                                         |
