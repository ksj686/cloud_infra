...
- **핵심 원칙:**
  ...
  - **Automation:** Bash 쉘 스크립트, IaC(Ansible/Terraform), GitOps 기반 운영 자동화 구현
  - **Optimization:** OpenTelemetry/APM 및 부하 테스트 기반의 애플리케이션/시스템 성능 튜닝
...
- **Web/Proxy:** Nginx
- **Container:** Docker (Bridge, MacVLAN, Named Volumes)
