...
본 문서는 하드웨어 장애 시에도 데이터 가용성을 높이는 분산 스토리지 시스템인 Ceph의 핵심 기술 원리 및 아키텍처 분석 내용 정리
...
- **운영 주의:** 하드웨어 RAID로 여러 디스크를 하나의 논리 디스크로 숨기면 Ceph의 장애 감지와 CRUSH 기반 배치 최적화가 제한될 수 있으므로, RAID는 Ceph 복제를 대체하거나 중첩하는 기본 전략으로 사용하지 않음.
